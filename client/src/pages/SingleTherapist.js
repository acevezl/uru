            ...
            <div className="container col-xxl-8 px-4 py-5">
                <div className="row flex-lg-row-reverse align-items-center g-5">
                    <div className="col-10 col-sm-8 col-lg-6">
                        {/* src={therapist.photo} */}
                        <img src="https://media.istockphoto.com/photos/mature-counselor-listens-compassionately-to-unrecognizable-female-picture-id1207514066?k=6&m=1207514066&s=612x612&w=0&h=uUD9MiHMyHhstKqLXI1vl6W9WnncYH8BTL1DCCXHR6w=" className="d-block mx-lg-auto img-fluid" alt="Therapist Stock Photo" width="400" height="300" loading="lazy" />
                    </div>
